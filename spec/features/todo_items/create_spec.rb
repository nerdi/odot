...
describe "Create todo items" do
  let!(:todo_list) { TodoList.create(title: "Grocery list", description: "Groceries are plenty") }
  ...
  it "displays an error with no content" do
    ...
    click_button "Save"
    within("div.flash") do
      expect(page).to have_content("There was a problem with the item... Please try again")
    end
